...
<style>
	...
	.page{overflow:hidden}.head{padding-right:170rpx}.rank{flex:none;white-space:nowrap}.mode-tabs-wrap{height:112rpx;padding:20rpx 22rpx 0;background:#f1f4f3;box-sizing:border-box}.mode-tabs{height:82rpx;padding:6rpx;display:flex;align-items:center;border:1rpx solid #e4e9e7;border-radius:42rpx 42rpx 26rpx 26rpx;background:#e9eeec;box-sizing:border-box;overflow:visible}.mode-tab{position:relative;flex:1;height:68rpx;display:flex;align-items:center;justify-content:center;border-radius:34rpx;color:#737d79;font-size:25rpx;font-weight:700;transition:transform .2s ease-out,color .2s ease-out,background-color .2s ease-out}.mode-tab.active{height:82rpx;transform:translateY(-9rpx);border:1rpx solid #dcece6;border-radius:38rpx 38rpx 19rpx 19rpx;background:#fbfefd;color:#1eaa82;font-size:28rpx;font-weight:900;box-shadow:0 10rpx 24rpx rgba(42,102,84,.11)}.mode-tab-dot{position:absolute;left:50%;bottom:8rpx;width:28rpx;height:5rpx;transform:translateX(-50%);border-radius:4rpx;background:#35cda4}.body,.order-host{height:calc(100vh - 278rpx)}
</style>
